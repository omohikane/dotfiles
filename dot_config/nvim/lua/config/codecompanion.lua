...
function M.setup()
	...
	cc.setup({
		...
		strategies = {
			...
			inline = { adapter = "openai_ollama", model = OLLAMA_MODEL, opts = {} },
			cmd = { adapter = "openai_ollama", model = OLLAMA_MODEL, opts = {} },
		},
	})

	-- Safety wrapper: ensure inline/chat always get opts
	do
